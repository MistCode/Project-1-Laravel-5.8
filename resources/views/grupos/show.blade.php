...
@section('content')
	...
	@if($mostrar->avatar != null)
		<img style="height: 150px; width: 100px; margin-top: 5px;" src="images/{{ $mostrar->avatar }}" class="card-img-top rounded-circle mx-auto d-block border border-primary" alt="">
	@endif
